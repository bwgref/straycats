...
# Set the "public" cutoff date to be Jan 19, 2021
...
tab.write('fits/straycats_incr2.fits', overwrite=True)

# Read the v1
from astropy.table import vstack

v1 = Table.read('fits/straycats.fits', format = 'fits')
v2_incr = Table.read('fits/straycats_incr2.fits', format = 'fits')
v2 = vstack([v1, v2_incr])
v2.write('fits/straycats_v2.fits', overwrite=True)
